...
\begin{DoxyCode}
62     \{
63         $params[\textcolor{stringliteral}{'message'}] = Lang::get(\textcolor{stringliteral}{'dma.friends::lang.log.activity'}, [
64             \textcolor{stringliteral}{'name'}  => $params[\textcolor{stringliteral}{'user'}]->name, 
65             \textcolor{stringliteral}{'title'} => $params[\textcolor{stringliteral}{'object'}]->title
66         ]);
67 
68         self::write(\textcolor{stringliteral}{'activity'}, $params);
69     \}
\end{DoxyCode}
...
\begin{DoxyCode}
81     \{
82         $params[\textcolor{stringliteral}{'message'}] = Lang::get(\textcolor{stringliteral}{'dma.friends::lang.log.artwork'}, [
83             \textcolor{stringliteral}{'name'}          => $params[\textcolor{stringliteral}{'user'}]->name, 
84             \textcolor{stringliteral}{'artwork\_id'}    => $params[\textcolor{stringliteral}{'artwork\_id'}],
85         ]); 
86 
87         self::write(\textcolor{stringliteral}{'artwork'}, $params);
88     \}
\end{DoxyCode}
...
\begin{DoxyCode}
100     \{
101         $params[\textcolor{stringliteral}{'message'}] = Lang::get(\textcolor{stringliteral}{'dma.friends::lang.log.checkin'}, [
102             \textcolor{stringliteral}{'name'}  => $params[\textcolor{stringliteral}{'user'}]->name, 
103             \textcolor{stringliteral}{'title'} => $params[\textcolor{stringliteral}{'object'}]->title
104         ]); 
105 
106         self::write(\textcolor{stringliteral}{'checkin'}, $params);
107     \}
\end{DoxyCode}
...
\begin{DoxyCode}
119     \{
120         $params[\textcolor{stringliteral}{'message'}] = Lang::get(\textcolor{stringliteral}{'dma.friends::lang.log.points'}, [
121             \textcolor{stringliteral}{'name'}          => $params[\textcolor{stringliteral}{'user'}]->name, 
122             \textcolor{stringliteral}{'points'}        => $params[\textcolor{stringliteral}{'points\_earned'}],
123             \textcolor{stringliteral}{'total\_points'}  => $params[\textcolor{stringliteral}{'user'}]->metadata->points,
124         ]); 
125 
126         self::write(\textcolor{stringliteral}{'points'}, $params);
127     \}
\end{DoxyCode}
...
\begin{DoxyCode}
139     \{
140         $params[\textcolor{stringliteral}{'message'}] = Lang::get(\textcolor{stringliteral}{'dma.friends::lang.log.reward'}, [
141             \textcolor{stringliteral}{'name'}  => $params[\textcolor{stringliteral}{'user'}]->name, 
142             \textcolor{stringliteral}{'title'} => $params[\textcolor{stringliteral}{'object'}]->title
143         ]); 
144 
145         self::write(\textcolor{stringliteral}{'reward'}, $params);
146     \}
\end{DoxyCode}
...
\begin{DoxyCode}
158     \{
159         self::write(\textcolor{stringliteral}{'unlocked'}, $params);
160     \}
\end{DoxyCode}
