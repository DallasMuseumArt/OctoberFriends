...
39             ->select(\textcolor{stringliteral}{'dma\_friends\_badges.title'}, \textcolor{stringliteral}{'dma\_friends\_badges.id'})
40             ->where(\textcolor{stringliteral}{'dma\_friends\_steps.activity\_id'}, $activity->id)->get();
41         \textcolor{keywordflow}{return} $badges;
42     \}
\end{DoxyCode}
