...
\item 
\hypertarget{classDMA_1_1Friends_1_1Classes_1_1ActivityForm_a661164febcd7fafdb40b95f4fceb0539}{}{\bfseries \$partials\+Dir} = \textquotesingle{}$\sim$/modules/backend/widgets/form/partials/\textquotesingle{}\label{classDMA_1_1Friends_1_1Classes_1_1ActivityForm_a661164febcd7fafdb40b95f4fceb0539}
...
\begin{DoxyCode}
246     \{
247         \textcolor{keywordflow}{if} (!$field->dependsOn) \{
248             \textcolor{keywordflow}{return};
249         \}
250 
251         $dependsOn = is\_array($field->dependsOn) ? $field->dependsOn : [$field->dependsOn];
252         $dependsOn = htmlspecialchars(json\_encode($dependsOn), ENT\_QUOTES, \textcolor{stringliteral}{'UTF-8'});
253         \textcolor{keywordflow}{return} $dependsOn;
254     \}
\end{DoxyCode}
...
Parses a field\textquotesingle{}s name 
...
199                 \textcolor{keywordflow}{throw} \textcolor{keyword}{new} \hyperlink{namespaceApplicationException}{ApplicationException}(Lang::get(
...
215         $keyParts   = Helper::nameToArray($fieldName);
...
Locates a file based on it\textquotesingle{}s definition. If the file starts with an \char`\"{}at symbol\char`\"{}, it will be returned in context of the application base path, otherwise it will be returned in context of the view path. 
\begin{DoxyParams}[1]{Parameters}
...
158                 \textcolor{keywordflow}{throw} \textcolor{keyword}{new} \hyperlink{namespaceApplicationException}{ApplicationException}(Lang::get(
...
190     \}
\end{DoxyCode}
\hypertarget{classDMA_1_1Friends_1_1Classes_1_1ActivityForm_a63f9588fb768954aa6e792841ef7a798}{}\index{D\+M\+A\+::\+Friends\+::\+Classes\+::\+Activity\+Form@{D\+M\+A\+::\+Friends\+::\+Classes\+::\+Activity\+Form}!render@{render}}
...
\end{DoxyParamCaption}
)}\label{classDMA_1_1Friends_1_1Classes_1_1ActivityForm_a63f9588fb768954aa6e792841ef7a798}
...
114                 \textcolor{keywordflow}{throw} \textcolor{keyword}{new} \hyperlink{namespaceApplicationException}{ApplicationException}(Lang::get(
