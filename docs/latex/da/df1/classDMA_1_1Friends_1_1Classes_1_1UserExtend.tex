...
\begin{DoxyCode}
29     \{
30         \textcolor{keywordflow}{if} (!$user)
31             $user = \textcolor{keyword}{new} \hyperlink{namespaceRainlab_1_1User_1_1Models_1_1User}{User};
32 
33         $this->user = $user;
34     \}
\end{DoxyCode}
...
\begin{DoxyCode}
43     \{
44         \textcolor{keywordflow}{if} (!is\_int($points))
45             \textcolor{keywordflow}{throw} \textcolor{keyword}{new} Exception(\textcolor{stringliteral}{'Points must be an integer'});
46 
47         $this->user->points += $points;
48         $this->user->points\_this\_week += $points;
49 
50         \textcolor{keywordflow}{if} ($this->user->forceSave()) \{
51 
52             Event::fire(\textcolor{stringliteral}{'friends.user.pointsEarned'}, [$this->user, $points]);
53 
54             $params = [
55                 \textcolor{stringliteral}{'user'}          => $this->user,
56                 \textcolor{stringliteral}{'points\_earned'} => $points,
57             ];
58             \hyperlink{classDMA_1_1Friends_1_1Classes_1_1FriendsLog_a083fa01b3e143ca77bdbb1562db724de}{FriendsLog::points}($params);
59         \}
60     \}
\end{DoxyCode}
