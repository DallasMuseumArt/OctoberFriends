...
\begin{DoxyCode}
79     \{
80         \textcolor{keywordflow}{if} (!is\_numeric($points))
81             \textcolor{keywordflow}{throw} \textcolor{keyword}{new} \hyperlink{namespaceSystemException}{SystemException}(\textcolor{stringliteral}{'Points must be an integer'});
82 
83         \textcolor{keywordflow}{if} ($this->user->points < $points) \{
84             \textcolor{keywordflow}{return} \textcolor{keyword}{false};
85         \}
86 
87         $this->user->points -= $points;    
88 
89         \textcolor{keywordflow}{if} ($deduct) \{    
90             $this->user->points\_this\_week -= $points;
91             $this->user->points\_today -= $points;
92         \}
93         
94         \textcolor{keywordflow}{if} ($this->user->forceSave()) \{
95             Event::fire(\textcolor{stringliteral}{'dma.friends.user.pointsRemoved'}, [$this->user, $points]);
96         \}
97 
