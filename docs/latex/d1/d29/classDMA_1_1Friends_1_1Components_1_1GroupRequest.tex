...
111                                     \{
112                 
113         \textcolor{keywordflow}{if} (($groupId = post(\textcolor{stringliteral}{'groupId'})) != \textcolor{stringliteral}{''})\{
114             
115             $group = UserGroup::findOrFail($groupId);
116             
117             \textcolor{keywordflow}{if} (($status = post(\textcolor{stringliteral}{'status'})) != \textcolor{stringliteral}{''})\{
118                 $user = $this->getuser();
119                 
120                 \textcolor{keywordflow}{switch} ($status)\{
121                     \textcolor{keywordflow}{case} UserGroup::MEMBERSHIP\_ACCEPTED:
122                         $group->acceptMembership($user);
123                         \textcolor{keywordflow}{break};
124                         
125                     \textcolor{keywordflow}{case} UserGroup::MEMBERSHIP\_REJECTED:
126                         $group->rejectMembership($user);
127                         \textcolor{keywordflow}{break};
128                         
129                     \textcolor{keywordflow}{case} UserGroup::MEMBERSHIP\_CANCELLED:
130                         $group->cancelMembership($user);
...
136         
137         
138         \textcolor{comment}{// Updated list of request and other vars}
