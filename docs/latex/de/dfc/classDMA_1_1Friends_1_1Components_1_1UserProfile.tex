...
\begin{DoxyCode}
187     \{
188         $this->addJs(\textcolor{stringliteral}{'/modules/system/assets/ui/vendor/bootstrap/js/modal.js'});
189         $this->addJs(\textcolor{stringliteral}{'/modules/system/assets/ui/js/popup.js'});
190     \}
\end{DoxyCode}
