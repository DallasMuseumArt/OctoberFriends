...
\begin{DoxyCode}
188     \{
189         $this->addJs(\textcolor{stringliteral}{'/modules/system/assets/ui/vendor/bootstrap/js/modal.js'});
190         $this->addJs(\textcolor{stringliteral}{'/modules/system/assets/ui/js/popup.js'});
191     \}
\end{DoxyCode}
...
\begin{DoxyCode}
237     \{
238         $theme = Theme::getActiveTheme();
239         \textcolor{keywordflow}{return} $theme->getPath() . \textcolor{stringliteral}{'/partials/'};
240     \}
\end{DoxyCode}
...
\begin{DoxyCode}
176     \{
177         $user = Auth::getUser();
178 
179         \textcolor{keywordflow}{if} (!$user) \textcolor{keywordflow}{return} \textcolor{keyword}{false};
180 
181         \textcolor{keywordflow}{return} $user;
182     \}
\end{DoxyCode}
...
\begin{DoxyCode}
96     \{
97         \textcolor{keywordflow}{return} $this->renderPartial(\textcolor{stringliteral}{'@changepassword'});
98     \}
\end{DoxyCode}
...
142         $vars = post();
143 
144         \textcolor{keywordflow}{foreach}($vars as $key => $val) \{
145             \textcolor{keywordflow}{if} ($key == \textcolor{stringliteral}{'metadata'}) \{
146                 \textcolor{keywordflow}{foreach}($val as $metakey => $metaval) \{
147                     $user->metadata->\{$metakey\} = $metaval;
148                 \}
149 
150             \} \textcolor{keywordflow}{else} \{
151                 \textcolor{keywordflow}{if} ($key == \textcolor{stringliteral}{"phone"}) \{
152                     $val = UserExtend::parsePhone($val);
153                 \}
154 
155                 $user->\{$key\} = $val;
156             \}
157         \}
158 
159         \textcolor{keywordflow}{if} ($user->push()) \{
160             Flash::info(Lang::get(\textcolor{stringliteral}{'dma.friends::lang.user.save'}));
161         \} \textcolor{keywordflow}{else} \{
162             Flash::error(Lang::get(\textcolor{stringliteral}{'dma.friends::lang.user.saveFailed'}));
163         \}
164 
165         \textcolor{keywordflow}{return} [
166             \textcolor{stringliteral}{'#flashMessages'} => $this->renderPartial(\textcolor{stringliteral}{'@flashMessages'}),
167         ];
168     \}
\end{DoxyCode}
