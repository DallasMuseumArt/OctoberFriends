...
128         $txt     = $message->getContent();
129 
130         \textcolor{comment}{// Clean phone user}
131         $toPhone = $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1Notifications_1_1Channels_1_1ChannelSMS_aafb8c47b6e382d41069e13c3362b33fd}{cleanPhone}($toUser->phone);
132         \textcolor{keywordflow}{if}(!empty($toPhone))\{
133             $sms = $this->client->account->sms\_messages->create(
134                     $this->fromNumber, \textcolor{comment}{// From a Twilio number in your account}
135                     $toPhone, \textcolor{comment}{// Text any number}
136                     $txt
137             );
138         \}
139        
...
159         \{
160             $msg = \textcolor{keyword}{new} IncomingMessage($this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1Notifications_1_1Channels_1_1ChannelSMS_ae6e3c43b02d2ccbb3fc4bd63ac5d7c9e}{getKey}());
161             $msg->from($request[\textcolor{stringliteral}{'From'}]);
162             $msg->setContent($request[\textcolor{stringliteral}{'Body'}]);
163 
164             \textcolor{comment}{// TODO : this should be reusable for other channels}
165             $key = $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1Notifications_1_1Channels_1_1ChannelSMS_ae6e3c43b02d2ccbb3fc4bd63ac5d7c9e}{getKey}();
166             $event = strtolower(\textcolor{stringliteral}{"dma.channel.$key.incoming.data"});
167             Event::fire($event, [[$msg]]);
168             Log::debug(\textcolor{stringliteral}{'Processed Twilio incoming SMS'}, $msg->getData());
169         \}
170         \textcolor{keywordflow}{catch}(\(\backslash\)\hyperlink{namespaceException}{Exception} $e)
171         \{
172             Log::error(\textcolor{stringliteral}{'Processing Twilio webhook request'}, $request);
173             Log::error(sprintf(\textcolor{stringliteral}{'Processing Twilio webhook:  %s'}, $e));
174             $httpCode = 500;
175         \}
176 
177 
178         \textcolor{comment}{// Response message was read ok}
179         return \(\backslash\)Response::make(\textcolor{stringliteral}{'<Response></Response>'}, $httpCode);
180     \}
\end{DoxyCode}
