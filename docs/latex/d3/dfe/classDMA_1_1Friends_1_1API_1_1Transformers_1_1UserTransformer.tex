...
\begin{DoxyCode}
125     \{
126         $rewards = $instance->rewards;
127         \textcolor{keywordflow}{return} $this->collection($rewards, \textcolor{keyword}{new} ActivityTransformer(\textcolor{keyword}{false}));    
128     \}
\end{DoxyCode}
...
\begin{DoxyCode}
137     \{
138         $badges = $instance->badges;
139         \textcolor{keywordflow}{return} $this->collection($badges, \textcolor{keyword}{new} BadgeTransformer(\textcolor{keyword}{false}));
140     \}
\end{DoxyCode}
