...
\index{get\-Config@{get\-Config}!DMA::Friends::Classes::ActivityManager@{D\-M\-A\-::\-Friends\-::\-Classes\-::\-Activity\-Manager}}
...
170 
171         $formConfig = $this->activityType->getConfig();
172         $formConfig = $this->getConfigPath($formConfig);
173         
174         \textcolor{keywordflow}{if} (File::isFile($formConfig)) \{
175             \textcolor{keywordflow}{return} $this->makeConfig($formConfig);
...
\index{get\-Form\-Default\-Values@{get\-Form\-Default\-Values}!DMA::Friends::Classes::ActivityManager@{D\-M\-A\-::\-Friends\-::\-Classes\-::\-Activity\-Manager}}
...
193                 \textcolor{keywordflow}{throw} \textcolor{keyword}{new} SystemException(Lang::get(\textcolor{stringliteral}{'dma.friends::lang.exceptions.activityTypeNotInitiated'}
      ));
194 
...
\index{list\-Activities@{list\-Activities}!DMA::Friends::Classes::ActivityManager@{D\-M\-A\-::\-Friends\-::\-Classes\-::\-Activity\-Manager}}
...
\index{load\-Activities@{load\-Activities}!DMA::Friends::Classes::ActivityManager@{D\-M\-A\-::\-Friends\-::\-Classes\-::\-Activity\-Manager}}
...
\index{load\-Activity@{load\-Activity}!DMA::Friends::Classes::ActivityManager@{D\-M\-A\-::\-Friends\-::\-Classes\-::\-Activity\-Manager}}
...
\begin{DoxyCode}
222     \{
223         \textcolor{keywordflow}{if} (!$alias) \textcolor{keywordflow}{return};
224 
225         \textcolor{keywordflow}{if} (!$this->activityType) \{
226             $className = $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1ActivityManager_aff2ab3684ac9cc2714fd1d7957890584}{resolve}($alias);
227 
228             \textcolor{keywordflow}{if} (!$className)
229                 \textcolor{keywordflow}{throw} \textcolor{keyword}{new} SystemException(Lang::get(\textcolor{stringliteral}{'dma.friends::lang.exceptions.missingActivityClass'}, [\textcolor{stringliteral}{'
      class'} => $alias]));
230 
231             $this->activityType = \textcolor{keyword}{new} $className;
232         \}
233     \}
\end{DoxyCode}
...
\index{register\-Activity@{register\-Activity}!DMA::Friends::Classes::ActivityManager@{D\-M\-A\-::\-Friends\-::\-Classes\-::\-Activity\-Manager}}
...
\index{resolve@{resolve}!DMA::Friends::Classes::ActivityManager@{D\-M\-A\-::\-Friends\-::\-Classes\-::\-Activity\-Manager}}
...
\index{save\-Data@{save\-Data}!DMA::Friends::Classes::ActivityManager@{D\-M\-A\-::\-Friends\-::\-Classes\-::\-Activity\-Manager}}
...
\begin{DoxyCode}
208     \{
209         \textcolor{keywordflow}{if} (!$this->activityType)
210             $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1ActivityManager_a7e70e998e7e5fa750f02d8249d11f816}{loadActivity}($values[\textcolor{stringliteral}{'activity\_type'}]);
211 
212         $this->activityType->saveData($model, $values);
213     \}
\end{DoxyCode}
