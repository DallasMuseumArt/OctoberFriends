...
\item 
\hypertarget{classDMA_1_1Friends_1_1Models_1_1Usermeta_a95d74f02cd302db9566b8da29154e82d}{}{\bfseries \$guarded} = \mbox{[}\textquotesingle{}user\+\_\+id\textquotesingle{}\mbox{]}\label{classDMA_1_1Friends_1_1Models_1_1Usermeta_a95d74f02cd302db9566b8da29154e82d}
...
\begin{DoxyCode}
123     \{
124         \textcolor{keywordflow}{if} (!$user)
125             \textcolor{keywordflow}{return} null;
126 
127         \textcolor{keywordflow}{if} (!$user->metadata) \{
128 
129             $meta = \textcolor{keyword}{new} \textcolor{keyword}{static};            
130             User::find($user->getKey())->metadata()->save($meta);
131             $user = User::find($user->getKey());
132             
133         \}
134 
135         \textcolor{keywordflow}{return} $user->metadata;
136     \}
\end{DoxyCode}
...
\begin{DoxyCode}
159     \{
160         $states = State::where(\textcolor{stringliteral}{'country\_id'}, \textcolor{charliteral}{'='}, 1)->get();
161 
162         \textcolor{keywordflow}{return} [
163             \textcolor{stringliteral}{'gender'}            => self::$genderOptions,
164             \textcolor{stringliteral}{'states'}            => $states,
165             \textcolor{stringliteral}{'race'}              => self::$raceOptions,
166             \textcolor{stringliteral}{'household\_income'}  => self::$householdIncomeOptions,
167             \textcolor{stringliteral}{'education'}         => self::$educationOptions,
168         ];
169     \}
\end{DoxyCode}
...
\begin{DoxyCode}
142     \{
143         \textcolor{keywordflow}{return} $query->excludeStaff()->orderBy(\textcolor{stringliteral}{'points'}, \textcolor{stringliteral}{'desc'});
144     \}
\end{DoxyCode}
...
\begin{DoxyCode}
150     \{
151         \textcolor{keywordflow}{return} $query->where(\textcolor{stringliteral}{'current\_member'}, \textcolor{stringliteral}{'!='}, self::IS\_STAFF);
152     \}
\end{DoxyCode}
...
\end{DoxyCode}
Provide a list of education options for the user profile \hypertarget{classDMA_1_1Friends_1_1Models_1_1Usermeta_a1dca0217848634cab6e2ad205804e351}{}\index{D\+M\+A\+::\+Friends\+::\+Models\+::\+Usermeta@{D\+M\+A\+::\+Friends\+::\+Models\+::\+Usermeta}!\$fillable@{\$fillable}}
\index{\$fillable@{\$fillable}!D\+M\+A\+::\+Friends\+::\+Models\+::\+Usermeta@{D\+M\+A\+::\+Friends\+::\+Models\+::\+Usermeta}}
\subsubsection[{\$fillable}]{\setlength{\rightskip}{0pt plus 5cm}D\+M\+A\textbackslash{}\+Friends\textbackslash{}\+Models\textbackslash{}\+Usermeta\+::\$fillable\hspace{0.3cm}{\ttfamily [protected]}}\label{classDMA_1_1Friends_1_1Models_1_1Usermeta_a1dca0217848634cab6e2ad205804e351}
{\bfseries Initial value\+:}
\begin{DoxyCode}
= [
...
\end{DoxyCode}
\hypertarget{classDMA_1_1Friends_1_1Models_1_1Usermeta_a85cf8b9b7dd2582d64ac9e130dd0069d}{}\index{D\+M\+A\+::\+Friends\+::\+Models\+::\+Usermeta@{D\+M\+A\+::\+Friends\+::\+Models\+::\+Usermeta}!\$gender\+Options@{\$gender\+Options}}
