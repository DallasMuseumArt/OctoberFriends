...
\begin{DoxyCode}
222     \{
223         \textcolor{keywordflow}{return} Response::api()->errorForbidden();
224     \}
\end{DoxyCode}
...
\begin{DoxyCode}
291     \{
292         \textcolor{keywordflow}{return} Response::api()->errorForbidden();
293 
294     \}
\end{DoxyCode}
...
\begin{DoxyCode}
268     \{
269         \textcolor{keywordflow}{return} Response::api()->errorForbidden();
270     \}
\end{DoxyCode}
...
\begin{DoxyCode}
323     \{
324         \textcolor{keywordflow}{return} Response::api()->setStatusCode(422)->withArray([
325                 \textcolor{stringliteral}{'error'} => [
326                         \textcolor{stringliteral}{'code'} => 422,
327                         \textcolor{stringliteral}{'http\_code'} => \textcolor{stringliteral}{'GEN-UNPROCESSABLE'},
328                         \textcolor{stringliteral}{'message'} => $message,
329                         \textcolor{stringliteral}{'errors'} => $errors
330                 ]
331         ]);
332     \}
\end{DoxyCode}
...
201             $model      = $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1API_1_1BaseResource_acff925772bdea0601cc8c926ca11d51e}{getModel}();
202             $query      = $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1API_1_1BaseResource_a98884c60fd1cd6a4b22b6b549c97e1e1}{applyFilters}($model);
203             
204             \textcolor{comment}{// Paginate result}
205             \textcolor{keywordflow}{return} $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1API_1_1BaseResource_aed3811d426c80763855a43280f822f97}{paginateResult}($query);
206         \} \textcolor{keywordflow}{catch}(\(\backslash\)\hyperlink{namespaceException}{Exception} $e) \{
207             \textcolor{comment}{// Send exception to log}
208             Log::error($e->getMessage());
209             Log::error($e->getTraceAsString());
210             
211             $message = $e->getMessage();
212             \textcolor{keywordflow}{return} Response::api()->errorInternalError($message);
213         \}
214     \}
\end{DoxyCode}
...
247             $model = $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1API_1_1BaseResource_acff925772bdea0601cc8c926ca11d51e}{getModel}();
248             $instance = $model->findOrFail($id);
249             \textcolor{keywordflow}{return} Response::api()->withItem($instance, $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1API_1_1BaseResource_a35abd35dbcf2d6cdafc569bb4a574756}{getTransformer}());
250         \}\textcolor{keywordflow}{catch}(ModelNotFoundException $e) \{
251             \textcolor{keywordflow}{return} Response::api()->errorNotFound();
252         \}\textcolor{keywordflow}{catch}(\hyperlink{namespaceException}{Exception} $e)\{
253             \textcolor{comment}{// Send exception to log}
254             Log::error($e->getMessage());
255             Log::error($e->getTraceAsString());
256             
257             \textcolor{keywordflow}{return} Response::api()->errorInternalError($e->getMessage());
258         \}
259     \}
\end{DoxyCode}
...
\begin{DoxyCode}
232     \{
233         \textcolor{keywordflow}{return} Response::api()->errorForbidden();
234     \}
\end{DoxyCode}
...
\begin{DoxyCode}
279     \{
280         \textcolor{keywordflow}{return} Response::api()->errorForbidden();
281 
282     \}
\end{DoxyCode}
...
\begin{DoxyCode}
305     \{
306         \textcolor{keywordflow}{foreach} ($attrsToUpdate as $attr) \{
307             $new\_value = array\_get($data, $attr, null);
308             \textcolor{keywordflow}{if}(!is\_null($new\_value)) \{
309                 $model->\{$attr\} = $new\_value;
310             \}
311         \}
312         \textcolor{keywordflow}{return} $model;
313     \}
\end{DoxyCode}
