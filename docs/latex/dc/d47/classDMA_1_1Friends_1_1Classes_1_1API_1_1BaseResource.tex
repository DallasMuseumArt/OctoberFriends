...
\begin{DoxyCode}
218     \{
219         \textcolor{keywordflow}{return} Response::api()->errorForbidden();
220     \}
\end{DoxyCode}
...
\begin{DoxyCode}
281     \{
282         \textcolor{keywordflow}{return} Response::api()->errorForbidden();
283 
284     \}
\end{DoxyCode}
...
\begin{DoxyCode}
258     \{
259         \textcolor{keywordflow}{return} Response::api()->errorForbidden();
260     \}
\end{DoxyCode}
...
\begin{DoxyCode}
313     \{
314         \textcolor{keywordflow}{return} Response::api()->setStatusCode(422)->withArray([
315                 \textcolor{stringliteral}{'error'} => [
316                         \textcolor{stringliteral}{'code'} => 422,
317                         \textcolor{stringliteral}{'http\_code'} => \textcolor{stringliteral}{'GEN-UNPROCESSABLE'},
318                         \textcolor{stringliteral}{'message'} => $message,
319                         \textcolor{stringliteral}{'errors'} => $errors
320                 ]
321         ]);
322     \}
\end{DoxyCode}
...
208             \textcolor{keywordflow}{return} Response::api()->errorInternalError($message);
209         \}
210     \}
\end{DoxyCode}
...
241             $model = $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1API_1_1BaseResource_acff925772bdea0601cc8c926ca11d51e}{getModel}();
242             $instance = $model->findOrFail($id);
243             \textcolor{keywordflow}{return} Response::api()->withItem($instance, $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1API_1_1BaseResource_a35abd35dbcf2d6cdafc569bb4a574756}{getTransformer}());
244         \}\textcolor{keywordflow}{catch}(ModelNotFoundException $e) \{
245             \textcolor{keywordflow}{return} Response::api()->errorNotFound();
246         \}\textcolor{keywordflow}{catch}(\hyperlink{namespaceException}{Exception} $e)\{
247             \textcolor{keywordflow}{return} Response::api()->errorInternalError();
248         \}
249     \}
\end{DoxyCode}
...
\begin{DoxyCode}
228     \{
229         \textcolor{keywordflow}{return} Response::api()->errorForbidden();
230     \}
\end{DoxyCode}
...
\begin{DoxyCode}
269     \{
270         \textcolor{keywordflow}{return} Response::api()->errorForbidden();
271 
272     \}
\end{DoxyCode}
