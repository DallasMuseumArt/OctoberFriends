...
\begin{DoxyCode}
116     \{
117         \textcolor{keywordflow}{return} $query->where(\textcolor{stringliteral}{'activity\_type'}, $type)
118             ->isActive();
119     \}
\end{DoxyCode}
...
\begin{DoxyCode}
125     \{   
126         \textcolor{keywordflow}{return} $query->where(\textcolor{stringliteral}{'wordpress\_id'}, $id);
127     \}  
\end{DoxyCode}
