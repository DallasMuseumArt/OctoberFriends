...
\begin{DoxyCode}
95     \{
96         $this->\hyperlink{classDMA_1_1Friends_1_1Classes_1_1PrintManager_a452bdf8905705bfce94858e232a02d81}{init}(
97             Settings::get(\textcolor{stringliteral}{'coupon\_width'}), 
98             Settings::get(\textcolor{stringliteral}{'coupon\_height'}), 
99             Settings::get(\textcolor{stringliteral}{'coupon\_orientation'})
100         );
101 
102         $expires = date( \textcolor{stringliteral}{'m-d-Y'}, strtotime( \textcolor{stringliteral}{"+"} . $reward->days\_valid .\textcolor{stringliteral}{" days"} ) );
103 
104         $logo = $this->getLogoPath();
105 
106         $this->pdf->Image($logo, 8, 1,-170);
107         
108         $this->pdf->Ln(14);     
109         $this->pdf->SetFont(\textcolor{stringliteral}{'Arial'}, \textcolor{charliteral}{'B'}, 8);
110         $this->pdf->setX(8);
111         $this->pdf->Write(4, $reward->fine\_print);
112         
113         $this->pdf->Ln(6);      
114         $this->pdf->SetFont(\textcolor{stringliteral}{'Arial'}, \textcolor{charliteral}{'B'}, 8);
115         $this->pdf->setY($this->pdf->getY());
116         $this->pdf->setX(7);
117         $this->pdf->Write(8, \textcolor{stringliteral}{"Expires: "} . $expires); \textcolor{comment}{//Expiration Date}
118         $this->pdf->Ln(7);      
119         $this->pdf->setX(8);
120         $this->pdf->Code39(8, $this->pdf->getY(), $reward->barcode);   \textcolor{comment}{//Bar Code}
121         $this->pdf->Ln(8);  
122         $this->pdf->setX(8);    
123         $this->pdf->SetFont(\textcolor{stringliteral}{'Arial'}, \textcolor{charliteral}{'B'}, 8);
124         $this->pdf->setY($this->pdf->getY()+8);     
125         
126         $this->pdf->setX(8);
127         $this->pdf->Write(8, Lang::get(\textcolor{stringliteral}{'dma.friends::lang.rewards.couponText'}));
128         
129         $this->pdf->setX(8);
130         $this->pdf->Write(14, \textcolor{stringliteral}{'      '});
131 
132         $this->doPrint($this->location->print\_reward);
133 
134     \}
\end{DoxyCode}
