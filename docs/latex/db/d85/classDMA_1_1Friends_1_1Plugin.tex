...
25             \textcolor{stringliteral}{'name'}        => \textcolor{stringliteral}{'Friends'},
26             \textcolor{stringliteral}{'description'} => \textcolor{stringliteral}{'A platform for users to earn badges and redeem rewards'},
27             \textcolor{stringliteral}{'author'}      => \textcolor{stringliteral}{'Dallas Museum of Art'},
28             \textcolor{stringliteral}{'icon'}        => \textcolor{stringliteral}{'icon-leaf'}
29         ];
30     \}
\end{DoxyCode}
