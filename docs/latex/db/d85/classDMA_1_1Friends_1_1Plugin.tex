...
26             \textcolor{stringliteral}{'name'}        => \textcolor{stringliteral}{'Friends'},
27             \textcolor{stringliteral}{'description'} => \textcolor{stringliteral}{'A platform for users to earn badges and redeem rewards'},
28             \textcolor{stringliteral}{'author'}      => \textcolor{stringliteral}{'Dallas Museum of Art'},
29             \textcolor{stringliteral}{'icon'}        => \textcolor{stringliteral}{'icon-leaf'}
30         ];
31     \}
\end{DoxyCode}
