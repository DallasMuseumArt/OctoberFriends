...
\begin{DoxyCode}
407     \{
408         \textcolor{keywordflow}{if} (!isset($\_SERVER[\textcolor{stringliteral}{'HTTP\_X\_DEVICE\_UUID'}])) \textcolor{keywordflow}{return};
409 
410         $uuid = $\_SERVER[\textcolor{stringliteral}{'HTTP\_X\_DEVICE\_UUID'}];
411 
412         $manager = \textcolor{keyword}{new} LocationManager($uuid);
413     \}
\end{DoxyCode}
