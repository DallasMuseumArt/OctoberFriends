...
\item 
\hypertarget{classDMA_1_1Friends_1_1Plugin_acc1be499ecb2966c300f002f94b9e261}{{\bfseries register\+Markup\+Tags} ()}\label{classDMA_1_1Friends_1_1Plugin_acc1be499ecb2966c300f002f94b9e261}
...
152             \textcolor{stringliteral}{'DMA\(\backslash\)Friends\(\backslash\)Activities\(\backslash\)ActivityCode'}   => \textcolor{stringliteral}{'ActivityCode'},
153             \textcolor{stringliteral}{'DMA\(\backslash\)Friends\(\backslash\)Activities\(\backslash\)LikeWorkOfArt'}  => \textcolor{stringliteral}{'LikeWorkOfArt'},
154         ];
155     \}
\end{DoxyCode}
...
\begin{DoxyCode}
410     \{
411         \textcolor{keywordflow}{if} (!isset($\_SERVER[\textcolor{stringliteral}{'HTTP\_X\_DEVICE\_UUID'}])) \textcolor{keywordflow}{return};
412 
413         $uuid = $\_SERVER[\textcolor{stringliteral}{'HTTP\_X\_DEVICE\_UUID'}];
414 
415         $manager = \textcolor{keyword}{new} LocationManager($uuid);
416     \}
\end{DoxyCode}
